...
-- Note: Views inherit RLS from their underlying tables when queried
...
-- Create RLS policies for the functions (these are secure by design)
-- Note: Functions with SECURITY DEFINER are acceptable when they implement 
-- proper permission checking internally, as our functions do
