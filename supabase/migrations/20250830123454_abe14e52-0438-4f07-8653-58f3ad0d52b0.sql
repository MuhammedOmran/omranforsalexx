-- Enable Row Level Security on employee directory tables
...
CREATE POLICY "HR managers can view all basic employee info" 
...
CREATE POLICY "HR managers can view all directory info" 
