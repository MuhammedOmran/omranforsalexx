...
CREATE INDEX idx_invoices_deleted_at ON public.invoices(deleted_at) WHERE deleted_at IS NOT NULL;
...
-- تحديث دالة حذف الفاتورة لاستخدام الحذف المؤقت
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RETURN QUERY SELECT FALSE, 'الفاتورة غير موجودة أو محذوفة مسبقاً';
        RETURN;
    END IF;
    ...
    RETURN QUERY SELECT TRUE, 'تم حذف الفاتورة مؤقتاً';
END;
$$;