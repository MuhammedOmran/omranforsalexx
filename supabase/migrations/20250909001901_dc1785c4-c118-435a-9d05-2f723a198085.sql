-- إنشاء الدوال المطلوبة لاستعادة سجلات الرواتب المحذوفة

-- دالة لجلب سجلات الرواتب المحذوفة
...
-- دالة لاستعادة جميع سجلات الرواتب المحذوفة
...
-- تعديل دالة حذف سجل الراتب لتحديث deleted_at بدلاً من الحذف المباشر
