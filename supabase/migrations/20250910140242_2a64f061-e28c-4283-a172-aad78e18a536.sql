-- تحديث أنواع التراخيص بالمواصفات المطلوبة
...
(
    'trial'::license_tier,
    'تجريبي',
    'ترخيص تجريبي لمدة 5 أيام - مستخدم واحد - جهاز واحد',
    5,
    1,
    1,
    0,
    '["basic_features", "limited_support", "single_user", "single_device"]'::jsonb,
    true
),
(
    'monthly'::license_tier,
    'شهري',
    'ترخيص شهري لمدة 30 يوم - 3 مستخدمين - 3 أجهزة',
    30,
    3,
    3,
    150,
    '["all_features", "email_support", "multi_user", "multi_device", "reports"]'::jsonb,
    true
),
(
    'quarterly'::license_tier,
    'ربع سنوي',
    'ترخيص لمدة 3 أشهر (90 يوم) - 5 مستخدمين - 5 أجهزة',
    90,
    5,
    5,
    400,
    '["all_features", "priority_support", "multi_user", "multi_device", "advanced_reports", "data_backup"]'::jsonb,
    true
),
(
    'yearly'::license_tier,
    'سنوي',
    'ترخيص سنوي لمدة 365 يوم - 5 مستخدمين - أجهزة لا محدودة',
    365,
    5,
    -1,
    1200,
    '["all_features", "priority_support", "multi_user", "unlimited_devices", "advanced_reports", "data_backup", "free_updates"]'::jsonb,
    true
),
(
    'premium'::license_tier,
    'مميز',
    'ترخيص مميز مدى الحياة - مستخدمين لا محدودين - أجهزة لا محدودة',
    36500,
    -1,
    -1,
    5000,
    '["all_features", "premium_support", "unlimited_users", "unlimited_devices", "advanced_reports", "data_backup", "lifetime_updates", "priority_access"]'::jsonb,
    true
);

-- دالة للتحقق من صحة الترخيص وحدود المستخدمين والأجهزة
...
BEGIN
    ...
    JOIN public.license_tiers lt ON ul.license_type = lt.tier_name::text
...
-- دالة للحصول على إحصائيات الترخيص
...
-- دالة لإنشاء ترخيص تجريبي تلقائياً للمستخدم الجديد
...
AS $$
BEGIN
    -- إنشاء ترخيص تجريبي تلقائياً عند إنشاء مستخدم جديد
...
-- إنشاء trigger لإنشاء ترخيص تجريبي تلقائياً
DROP TRIGGER IF EXISTS on_auth_user_created_trial_license ON auth.users;
CREATE TRIGGER on_auth_user_created_trial_license
