-- تحديث قيم الترخيص في قاعدة البيانات
-- إضافة أو تحديث مستوى ترخيص مدى الحياة
INSERT INTO public.license_tiers (tier_name, tier_name_ar, description, duration_days, price, max_users, max_devices, features, is_active)
VALUES (
  'lifetime',
  'مدى الحياة',
...
ON CONFLICT (tier_name) DO UPDATE SET
  ...
  tier_name_ar = 'مدى الحياة',
  description = 'ترخيص مدى الحياة - 1000 سنة',
  price = 5000,
  features = '["جميع الميزات", "مستخدمين غير محدودين", "أجهزة غير محدودة", "دعم مدى الحياة", "تحديثات مجانية مدى الحياة", "أولوية في الدعم"]'::jsonb,
  updated_at = now();

-- تحديث دالة إضافة الترخيص للتعامل مع الترخيص مدى الحياة
